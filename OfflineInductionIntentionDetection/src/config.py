...
debug = True # turn it on while in debug mode
...
sentence_dim = 64 # number of rnn states within sentence level, namely sentence vector length
dialogue_dim = 32 # number of rnn states within dialogue level, namely dialogue vector length
